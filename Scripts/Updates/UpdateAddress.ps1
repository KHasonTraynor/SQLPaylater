...
$NewValue = Read-Host("What would you like to change their STREET NAME and NUMBER to?")

$Update = "UPDATE Loans SET Address = '$NewValue' WHERE Customer_ID = '$Customer_ID'"                    
