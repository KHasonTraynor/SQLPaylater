...
$NewValue = Read-Host("What would you like to change their Gender to? (Must be M ,F, or O")

$Update = "UPDATE Loans SET Gender = '$NewValue' WHERE Customer_ID = '$Customer_ID'"                    
